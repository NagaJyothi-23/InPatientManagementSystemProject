...
public class PatientController {
	...
	public ResponseEntity<PatientEntity> save(@RequestBody PatientEntity patientEntity) {
		...
		ResponseEntity<PatientEntity> responseEntity = new ResponseEntity<>(patientEntity, HttpStatus.OK);
	...
	public ResponseEntity<PatientEntity> getProductById(@PathVariable Integer id) {
		...
		return new ResponseEntity<PatientEntity>(patientById,HttpStatus.OK);
	}
