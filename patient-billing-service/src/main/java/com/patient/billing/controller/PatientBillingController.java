...
public class PatientBillingController 
{
   ...
   public ResponseEntity<PatientBillingEntity> getById(@PathVariable Integer billingId)
   {
	   Optional<PatientBillingEntity> patient=service.getById(billingId);
...
//   }
   ...
   public ResponseEntity<PatientBillingEntity> update(
	   ...
	   PatientBillingEntity updatedEntity = service.update(billingId, paymentStatus);
