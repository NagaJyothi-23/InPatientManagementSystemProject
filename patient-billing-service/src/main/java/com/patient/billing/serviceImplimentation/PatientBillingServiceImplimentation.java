...
import com.patient.billing.exception.BillingIdNotFoundException;
...
public class PatientBillingServiceImplimentation implements PatientBillingService
{
	...
	@Override
	public Optional<PatientBillingEntity> getById(int billingId) {
		Optional<PatientBillingEntity> patientid=repository.findById(billingId);
		return patientid;
	}
	@Override
	public PatientBillingEntity update(int id,String paymentStatus) throws BillingIdNotFoundException
	{
...
//			double total=patientId.getTotalAmount();
			...
			throw new BillingIdNotFoundException("Billing id is not found");
